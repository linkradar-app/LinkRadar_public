/**
 * LinkRadar — GitHub Pages site config.
 * Update siteUrl when the repo is published on GitHub Pages.
 */
window.SITE_CONFIG = {
  projectName: "LinkRadar",
  tagline: "Like someone nearby — without the fear of being turned down.",
  description:
  ...
  /** App source (private) + public APK release for website download */
  githubRepoUrl: "https://github.com/linkradar-app/Linkradar",
  githubApkDownloadUrl:
    "https://github.com/linkradar-app/LinkRadar_public/releases/download/v1.0.0-debug/LinkRadar-debug.apk",
  ...
  logoUrl: "assets/logo-foreground.png",
